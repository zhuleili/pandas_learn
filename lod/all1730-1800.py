...
out_need_data = df[(df['EXIT_STATION_ID'] != 0) &
               (df['TRADE_TIME'] >= 20171123170000) & (df['TRADE_TIME'] < 20171123180100) &
...
out_group_data.to_excel('D:/数据处理/all_pm_out_1700-1800.xls')
...
# in_group_data.to_excel('D:/数据处理/all_am_in_0730-0830.xls')
# print(in_group_data.head(10))
# print('-----------------------------------')

# result_data = pd.DataFrame({'TRADE_TIME': in_group_data['TRADE_TIME'], 'OUT_STATION_ID': out_group_data['EXIT_STATION_ID'], 'OUT_SIZE': out_group_data['size'],
#                             'IN_STATION_ID': in_group_data['ENTRY_STATION_ID'],'IN_SIZE': in_group_data['size']})
# print(out_group_data['OUT_SIZE'].add(in_group_data, fill_value=0))


# group_data.to_excel('D:/数据处理/all0730-0830.xls')
